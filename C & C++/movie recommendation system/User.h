...
public:
     ...
     * @return
     */
    rank_map* get_ranks()const{return _map;}
	...
	/**
	 * returns a recommendation according to t
	 * he similarity recommendation method
	 * @param k the number of the most similar
	 * movies to calculate by
	 * @return recommendation
	 */
	 ...
	 */
	double get_prediction_score_for_movie(const std::string&
