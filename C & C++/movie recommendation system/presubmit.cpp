...
int TestPCompilation_4 ()
{
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("../presubmit"
                                                               ".in_m");
  std::vector<User> user = UsersLoader::create_users ("../presubmit.in_u",
                                                      std::move (rs));
...
int TestComparison_4 ()
{
  ...
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("../presubmit"
                                                               ".in_m4");
  std::vector<User> user = UsersLoader::create_users ("../presubmit.in_u4",
                                                      std::move (rs));
...
auto a = user[15].get_recommendation_by_cf (4)->get_year ();
